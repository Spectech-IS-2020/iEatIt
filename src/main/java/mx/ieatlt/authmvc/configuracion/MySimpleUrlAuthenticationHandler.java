...
public class MySimpleUrlAuthenticationHandler implements AuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(final Authentication authentication) {
        ...
        roleTargetUrlMap.put(Role.ADMINISTRADOR.toString(), "/administrador/index");
        roleTargetUrlMap.put(Role.CLIENTE.toString(), "/cliente/index");
        roleTargetUrlMap.put(Role.REPARTIDOR.toString(), "/repartidor/index");
